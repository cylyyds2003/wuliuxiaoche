...
#状态机 0为寻找二维码 1为物块识别 2为靶心识别
flag = 2
#颜色标志位 0为红色 1为绿色 2为蓝色
color_flag = 0
#颜色识别阈值
thresholds = [(21, 39, 10, 62, 8, 127), # 红色阈值
              (35, 75, -128, -4, -128, 127), # 绿色阈值
              (17, 39, -128, 127, -128, 0)] # 蓝色阈值
        ...
        if color_flag == 0:
            ...
            if blobs:
                ...
                if circles:
                    ...
                    # 可以在这里对最小半径的圆min_circle进行其他操作，比如绘制
